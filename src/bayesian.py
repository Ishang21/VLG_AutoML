...
class BayesianOptimizer:
    ...
    def __init__( self,
        ...
        # self.y = np.array(
        #     [self.func(**self.__check_int_param(dict(zip(self.param_names, p)))) for p in self.init_points]
        # )
    ...
    def optimize(self):
        ...
        for i in range(self.max_iter):
            ...
            next_best_y = self.func((dict(zip(self.param_names, next_best_x))))
